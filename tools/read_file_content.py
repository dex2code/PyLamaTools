...
def read_file_content(
    tool_path: str, encoding: str = "utf-8", max_chars: Optional[int] = None
) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        result["error"] = (
            f"Файл '{tool_path}' не найден (возможно, он был удален или перемещен)."
        )
        ...
        result["error"] = (
            f"Ошибка декодирования файла '{tool_path}' "
